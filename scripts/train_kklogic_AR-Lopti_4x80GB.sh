...
EXP_NAME="Qwen2.5-7B-Instruct-1M-kklogic_grpo_AR-Lopti"
MAX_PROMPT=400
MICRO_BS=32
VAL_N=16
TRAIN_BS=64
...
REWEIGHT_K=0.3  # alpha in the paper; Note that alpha=0.0 means no reweighting
REWEIGHT_TAU=0.7   # (1 - alpha) in the paper
NEG_ADV_WEIGHT=1.0
